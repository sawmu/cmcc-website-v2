...
function enqueue_parent_styles() {
    ...
    wp_enqueue_style( 'fontawesomecss', get_stylesheet_directory_uri().'/library/fontawesome/css/all.min.css' );
    wp_enqueue_style( 'bootstrap', get_stylesheet_directory_uri().'/library/bootstrap-4.5/bootstrap.min.css' );
	wp_enqueue_style( 'cmcc-style', get_stylesheet_directory_uri().'/css/cmcc-style.css' ); 
	wp_enqueue_style( 'cmcc-style', get_stylesheet_directory_uri().'/css/cmcc-media.css' );   
...
function custom_scripts_and_styles() {
	...
	wp_register_script( 'Slick-script', 'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js', null, null, true );
	wp_enqueue_script('Slick-script');
    // Custom Script
	// wp_enqueue_script( 'jquery', $path.'/library/slick/jquery.min.js');
    wp_enqueue_script( 'script', $path.'/main.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'slick', $path.'/library/slick/slick.js');
    wp_enqueue_script( 'slickmain', $path.'/library/slick/slick.min.js');
    wp_enqueue_script( 'fontawesomejs', get_stylesheet_directory_uri().'/library/fontawesome/js/all.min.js' );
    wp_enqueue_script( 'popper', get_stylesheet_directory_uri().'/library/bootstrap-4.5/popper.min.js' ); 
    wp_enqueue_script( 'bootstrap', get_stylesheet_directory_uri().'/library/bootstrap-4.5/bootstrap.min.js' );

  ...
  <div class="tab-content" id="nav-tabContent">
    ...
    if( have_rows('programmes_list') ):
      ...
      while( have_rows('programmes_list') ) : the_row();
        ...
        $read_more_link = get_sub_field('read_morer_link');
        $upload_image = get_sub_field('upload_image');

    ?>

    <?php if ($i == 0) : ?>
      <div class="row tab-pane fade show active" id="nav-subject-<?=$tab_name->slug;?>" role="tabpanel" aria-labelledby="nav-<?=$tab_name->slug;?>">
        <div class="program-detail col-sm-4">
          <a href="<?=$read_more_link;?>" class="read-more-btn">
          <div class="class-backg">
    ...
    <?php else:// var_dump($tab); var_dump($tab_name->slug); ?>
      ...
      <?php else: ?>
        ...
        <div class=" flex  tab-pane fade show" id="nav-subject-<?=$tab_name->slug;?>" role="tabpanel" aria-labelledby="nav-<?=$tab_name->slug;?>">
        <div class="program-detail col-sm-4">
          <a href="<?=$read_more_link;?>" class="read-more-btn">
          <div class="class-backg">
            <div class="program-image">
